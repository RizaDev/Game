...
.defines(function(){
    ...
    enemyExplosion = ig.Entity.extend({
        // layer index 100 dibawah layer result
        // dimana index result bernilai 9999
        zIndex:100,
        // buat animasi transparasi dari 1 ke 0
        ...
        draw:function(){
            ...
            ctx.globalAlpha = this.alphaEffect;
            // eksekusi animasi gambar yang membesar
            ctx.arc(this.pos.x,this.pos.y,10*this.scaleEffect, 0, 2*Math.PI);
            ctx.fill();
            ctx.stroke();
            ctx.restore();
        },
    ...
    enemyAnimExplosion = ig.Entity.extend({
        lifetime: .6,
